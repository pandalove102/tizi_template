						...
						<div id="owl-demo" class="owl-carousel owl-theme">
							<div class="item">
								<div class="product-img">
									<img class="img-fluid" src="<?=template_classixer?>assets/img/productinfo/img1.jpg" alt="">
								</div>
								<span class="price">$1,550</span>
							</div>
							<div class="item">
								<div class="product-img">
									<img class="img-fluid" src="<?=template_classixer?>assets/img/productinfo/img2.jpg" alt="">
								</div>
								<span class="price">$1,550</span>
							</div>
							<div class="item">
								<div class="product-img">
									<img class="img-fluid" src="<?=template_classixer?>assets/img/productinfo/img3.jpg" alt="">
								</div>
								<span class="price">$1,550</span>
							</div>
						</div>
