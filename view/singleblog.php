							...
							<ol class="comments-list">
								<li>
									<div class="media">
										<div class="thumb-left">
											<a href="#">
												<img class="img-fluid" src="<?=template_classixer?>assets/img/blog/user1.jpg" alt="">
											</a>
										</div>
										<div class="info-body">
									...
									<ul>
										<li>
											<div class="media">
												<div class="thumb-left">
													<a href="#">
														<img class="img-fluid" src="<?=template_classixer?>assets/img/blog/user2.jpg" alt="">
													</a>
												</div>
												<div class="info-body">
													<div class="media-heading">
								...
								<li>
									<div class="media">
										<div class="thumb-left">
											<a href="#">
												<img class="img-fluid" src="<?=template_classixer?>assets/img/blog/user3.jpg" alt="">
											</a>
										</div>
										<div class="info-body">
											<div class="media-heading">
