			...
			<div class="row">
				<div class="col-lg-8 col-md-12 col-xs-12">
					...
					<div class="blog-post">
						...
						<div class="post-thumb">
							<a href="#"><img class="img-fluid" src="<?=template_classixer?>assets/img/blog/blog1.jpg" alt=""></a>
						...
						<div class="post-content">
							<ul class="list-inline cat-meta">
								<li class="tr-cats"><a href="#">Blogging</a></li>
							</ul>
					...
					<div class="blog-post">
						...
						<div class="post-thumb">
							<a href="#"><img class="img-fluid" src="<?=template_classixer?>assets/img/blog/blog2.jpg" alt=""></a>
							<div class="hover-wrap"></div>
						</div>
						...
						<div class="post-content">
							<ul class="list-inline cat-meta">
								<li class="tr-cats"><a href="#">Social</a></li>
							</ul>
					...
					<div class="blog-post">
						...
						<div class="post-thumb">
							<a href="#"><img class="img-fluid" src="<?=template_classixer?>assets/img/blog/blog3.jpg" alt=""></a>
							<div class="hover-wrap"></div>
						</div>
						...
						<div class="post-content">
							<ul class="list-inline cat-meta">
								<li class="tr-cats"><a href="#">Marketing</a></li>
							</ul>
					...
					<div class="blog-post video-post">
						...
						<div class="post-thumb">
							<div class="video-wrapper">
								<iframe width="100%" height="315" src="<?=template_classixer?>https://www.youtube.com/embed/qighCE8WfBk" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
							</div>
						</div>
				...
				<aside id="sidebar" class="col-lg-4 col-md-12 col-xs-12 right-sidebar">
						...
						<ul class="posts-list">
							<li>
								<div class="widget-thumb">
									<a href="#"><img src="<?=template_classixer?>assets/img/blog/thumb1.jpg" alt="" /></a>
								</div>
							...
							<li>
								<div class="widget-thumb">
									<a href="#"><img src="<?=template_classixer?>assets/img/blog/thumb2.jpg" alt="" /></a>
								</div>
								<div class="widget-content">
							...
							<li>
								<div class="widget-thumb">
									<a href="#"><img src="<?=template_classixer?>assets/img/blog/thumb3.jpg" alt="" /></a>
								</div>
								<div class="widget-content">
							...
							<li>
								<div class="widget-thumb">
									<a href="#"><img src="<?=template_classixer?>assets/img/blog/thumb4.jpg" alt="" /></a>
								</div>
								<div class="widget-content">
							...
							<li>
								<div class="widget-thumb">
									<a href="#"><img src="<?=template_classixer?>assets/img/blog/thumb5.jpg" alt="" /></a>
								</div>
								<div class="widget-content">
									<a href="#">Eum Iriure Dolor Duis Autem</a>
					...
					<div class="widget">
						...
						<div class="add-box">
							<img src="<?=template_classixer?>assets/img/img1.jpg" alt="">
						</div>
					</div>
				</aside>
