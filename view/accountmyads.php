				...
				<div class="col-sm-12 col-md-4 col-lg-3 page-sidebar">
					<aside>
						<div class="sidebar-box">
							<div class="user">
								<figure>
									<a href="#"><img src="<?=template_classixer?>assets/img/author/img1.jpg" alt=""></a>
								</figure>
						...
						<div class="widget">
							...
							<div class="add-box">
								<img class="img-fluid" src="<?=template_classixer?>assets/img/img1.jpg" alt="">
							</div>
						</div>
					</aside>
				</div>
								...
								<table class="table table-responsive dashboardtable tablemyads">
									...
									<tbody>
										<tr data-category="active">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img1.jpg" alt=""></td>
											<td data-title="Title">
										...
										<tr data-category="active">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img2.jpg" alt=""></td>
											<td data-title="Title">
										...
										<tr data-category="inactive">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img3.jpg" alt=""></td>
											<td data-title="Title">
										...
										<tr data-category="sold">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img4.jpg" alt=""></td>
											<td data-title="Title">
										...
										<tr data-category="active">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img5.jpg" alt=""></td>
											<td data-title="Title">
										...
										<tr data-category="sold">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img6.jpg" alt=""></td>
											<td data-title="Title">
										...
										<tr data-category="expired">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img7.jpg" alt=""></td>
											<td data-title="Title">
										...
										<tr data-category="inactive">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img8.jpg" alt=""></td>
											<td data-title="Title">
										...
										<tr data-category="expired">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img9.jpg" alt=""></td>
											<td data-title="Title">
										...
										<tr data-category="deleted">
											...
											<td class="photo"><img class="img-fluid" src="<?=template_classixer?>assets/img/product/img10.jpg" alt=""></td>
											<td data-title="Title">
