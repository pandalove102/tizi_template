			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
				<div class="featured-box">
					<figure>
						...
						<a href="#"><img class="img-fluid" src="<?=template_classixer?>assets/img/featured/img2.jpg" alt=""></a>
					</figure>
					<div class="feature-content">
						<div class="product">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
				<div class="featured-box">
					<figure>
						...
						<a href="#"><img class="img-fluid" src="<?=template_classixer?>assets/img/featured/img3.jpg" alt=""></a>
					</figure>
					<div class="feature-content">
						<div class="product">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
				<div class="featured-box">
					<figure>
						...
						<a href="#"><img class="img-fluid" src="<?=template_classixer?>assets/img/featured/img4.jpg" alt=""></a>
					</figure>
					<div class="feature-content">
						<div class="product">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
				<div class="featured-box">
					<figure>
						...
						<a href="#"><img class="img-fluid" src="<?=template_classixer?>assets/img/featured/img6.jpg" alt=""></a>
					</figure>
					<div class="feature-content">
						<div class="product">
			...
			<div class="col-md-12 wow fadeIn" data-wow-delay="0.5s">
				...
				<div id="new-products1" class="owl-carousel">
					<div class="item">
						<div class="product-item">
							<div class="carousel-thumb">
								<img class="img-fluid" src="<?=template_classixer?>assets/img/product/img1.jpg" alt="">
								<div class="overlay">
								</div>
					...
					<div class="item">
						<div class="product-item">
							<div class="carousel-thumb">
								<img class="img-fluid" src="<?=template_classixer?>assets/img/product/img2.jpg" alt="">
								<div class="overlay">
								</div>
							</div>
							<div class="product-content">
					...
					<div class="item">
						<div class="product-item">
							<div class="carousel-thumb">
								<img class="img-fluid" src="<?=template_classixer?>assets/img/product/img3.jpg" alt="">
								<div class="overlay">
								</div>
					...
					<div class="item">
						<div class="product-item">
							<div class="carousel-thumb">
								<img class="img-fluid" src="<?=template_classixer?>assets/img/product/img4.jpg" alt="">
								<div class="overlay">
								</div>
							</div>
							<div class="product-content">
					...
					<div class="item">
						<div class="product-item">
							<div class="carousel-thumb">
								<img class="img-fluid" src="<?=template_classixer?>assets/img/product/img5.jpg" alt="">
								<div class="overlay">
								</div>
								<div class="btn-product bg-yellow">
									<a href="#">New</a>
					...
					<div class="item">
						<div class="product-item">
							<div class="carousel-thumb">
								<img class="img-fluid" src="<?=template_classixer?>assets/img/product/img6.jpg" alt="">
								<div class="overlay">
								</div>
							</div>
							<div class="product-content">
					...
					<div class="item">
						<div class="product-item">
							<div class="carousel-thumb">
								<img class="img-fluid" src="<?=template_classixer?>assets/img/product/img7.jpg" alt="">
								<div class="overlay">
								</div>
								<div class="btn-product bg-red">
					...
					<div class="item">
						<div class="product-item">
							<div class="carousel-thumb">
								<img class="img-fluid" src="<?=template_classixer?>assets/img/product/img8.jpg" alt="">
								<div class="overlay">
								</div>
							</div>
							<div class="product-content">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="table">
					...
					<div class="pricing-header">
						<p class="price-value"><sup>$</sup>29<span>/ Mo</span>
						</p>
					</div>
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="table" id="active-tb">
					...
					<div class="pricing-header">
						<p class="price-value"><sup>$</sup>89<span>/ Mo</span>
						</p>
					</div>
					<ul class="description">
						<li><strong>Free</strong> ad posting</li>
			...
			<div class="col-lg-4 col-md-6 col-xs-12">
				<div class="table">
					...
					<div class="pricing-header">
						<p class="price-value"><sup>$</sup>99<span>/ Mo</span>
						</p>
					</div>
					<ul class="description">
						<li><strong>Free</strong> ad posting</li>
				...
				<div id="testimonials" class="owl-carousel">
					<div class="item">
						<div class="testimonial-item">
							<div class="img-thumb">
								<img src="<?=template_classixer?>assets/img/testimonial/img1.png" alt="">
							</div>
							<div class="content">
					...
					<div class="item">
						<div class="testimonial-item">
							<div class="img-thumb">
								<img src="<?=template_classixer?>assets/img/testimonial/img2.png" alt="">
							</div>
							<div class="content">
					...
					<div class="item">
						<div class="testimonial-item">
							<div class="img-thumb">
								<img src="<?=template_classixer?>assets/img/testimonial/img3.png" alt="">
							</div>
							<div class="content">
